...
export function animate(widget: mod.UIWidget): { to(props: TweenProps, options?: TweenOptions): Promise<void> } {
    return {
...
export function timeline(options?: TweenOptions): Timeline {
